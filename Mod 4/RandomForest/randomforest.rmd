...
```{r}
#drug_data_2 = drug_data_2 %>% mutate(DonatedMarch = as_factor(DonatedMarch)) %>% 
...
```{r}
d1 = ggplot(train, aes(x = Age, fill = Nicotine)) + geom_bar(position = "fill")
d2 = ggplot(train, aes(x = Gender, fill = Nicotine)) + geom_bar(position = "fill")
d3 = ggplot(train, aes(x = Education, fill = Nicotine)) + geom_bar(position = "fill")
d4 = ggplot(train, aes(x = Country, fill = Nicotine)) + geom_bar(position = "fill")
